...
* ESGF-NG proposal, agreed to at the Nth ESGF conference, Bethesda, MD, YYYY-MM.
* Design documents are available in the ESGF/esgf-roadmap GitHub repository. See core-architecture folder.
...
| The Past | Activity |
| --- | --- |
| 2024-04-22 - 2024-04-24 | ESGF-NG proposed at 10th ESGF conference in Bethesda, MD (USA) |
...
| 2024-12 | Globus uses updated ESGF publisher and ESGF-NG deployment to publish 500 CMIP6 datasets; successfully ingested into West STAC catalog. |
| 2025-01 | CEDA deploys East STAC catalog and ingests datasets published by Globus. |
| 2025-02 | CEDA publishes 500 CMIP6 datasets; successfully ingested (with one duplication error) into both East and West STAC catalogs. Minor discrepancies in catalog entries spotted. |
...
* Data Challenge 2 is an end-to-end publication and update test. It has not begun.
* Data Challenge 3 is an end-to-end publication and retraction test. It has not begun.
